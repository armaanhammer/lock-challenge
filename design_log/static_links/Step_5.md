...
1. Rapidjson headers need to be placed in the [/Step_5/rapidjson/ directory](https://github.com/armaanhammer/lock-challenge/tree/master/src/Step_5/rapidjson) for the program to build. For convenience, the headers from the [66eb606 commit](https://github.com/Tencent/rapidjson/tree/66eb6067b10fd02e419f88816a8833a64eb33551/include/rapidjson) have been included already. If desired, it may be possible to update the headers to the current commit by replacing the entire rapidjson directory in this project the current [rapidjson/include/rapidjson directory](https://github.com/Tencent/rapidjson/tree/master/include/rapidjson).
1. In the [/src/Step_5/build/ directory](https://github.com/armaanhammer/lock-challenge/tree/master/src/Step_5/build) run `cmake ../`. The build environment will be set up in that directory using the [CMakeLists.txt file](https://github.com/armaanhammer/lock-challenge/tree/master/src/Step_5/CMakeLists.txt) in the parent directory.
1. Enure that the bool value for `TEST_ALL` [on line 37 of main.cpp](https://github.com/armaanhammer/lock-challenge/tree/master/src/Step_5/main.cpp#L37) is set to the desired value:
...
1. In the [/src/Step_5/build/ directory](https://github.com/armaanhammer/lock-challenge/tree/master/src/Step_5/build/) run `make`. Executable will build as `dispatcher`. 
1. To run executable, run `./dispatcher`.
1. If the final command (exit_command) [on line 804 of main.cpp](https://github.com/armaanhammer/lock-challenge/tree/master/src/Step_5/main.cpp#L804) is not commented out, the exit_command will succeed, terminating execution. If it is commented out, execution will fall through to a user prompt. 
...
* [main.cpp](https://github.com/armaanhammer/lock-challenge/tree/master/src/Step_5/main.cpp) (with DEBUG code)
* [main_no_debug.cpp](https://github.com/armaanhammer/lock-challenge/tree/master/src/Step_5/main_no_debug.cpp) (identical, except without DEBUG code)
* [CMakeLists.txt file](https://github.com/armaanhammer/lock-challenge/tree/master/src/Step_5/CMakeLists.txt) (slightly modified from [prompt file](https://github.com/armaanhammer/lock-challenge/tree/master/prompt/CMakeLists.txt))
...
The prompt cpp file is available here: [/prompt/dispatcher_challenge.cpp](https://github.com/armaanhammer/lock-challenge/tree/master/prompt/dispatcher_challenge.cpp)
...
* [Parsing Code (Appendix)](https://github.com/armaanhammer/lock-challenge/tree/master/design_log/Step_5_Appendix.md#parsing-code)
* [Brainstorming (Appendix)](https://github.com/armaanhammer/lock-challenge/tree/master/design_log/Step_5_Appendix.md#brainstorming)
* [Research (Appendix)](https://github.com/armaanhammer/lock-challenge/tree/master/design_log/Step_5_Appendix.md#research)
